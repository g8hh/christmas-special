...
var cnItems = {
    ...
    "Boost games gain by x6, but": "提升游戏收益 x6，但",
    "Boost games gain based on ascensions.": "提升游戏收益基于转生。",
    ...
    "Gain 18.1% of money gain on reset per second. Is this an AD clone?": "每秒重置时获得 18.1% 的金钱收益。 这是 AD 克隆吗？",
    "games": "游戏",
    "Hexis": "六边形",
    ...
    "10.00% chance of winning": "10.00% 获胜机会",
    "'s effect) * (total ascensions) adds 333 to joy.": "的效果）*（总转生）增加 333 的喜悦。",
    "Not Naughty": "不淘气",
    "You lost! Better luck next time.": "你输了！ 下次好运。",
    "You won!": "你赢了！",
    "and all buyables within the coal layer, and they don't spend anything. You can select another": "",
    "": "",
    "": "",
    "": "",
    "": "",
