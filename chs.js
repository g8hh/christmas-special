...
var cnItems = {
    ...
    "Content": "内容",
    "Energical warp": "能量翘曲",
    "Gain the equivalent resources of 1 luminal energy reset every second.": "每秒获得相当于 1 次光能重置的资源。",
    "hyper-infinities": "超无限",
    "Magical Forest in the Middle of Nowhere": "荒野中的魔法森林",
    "magical leaves": "魔法树叶",
    "Auto": "自动",
    "Auto-Chargers": "自动充电",
    "Auto-Compressors": "自动压缩",
    "Auto-Self Chargers": "自动自行充电",
    "blue": "蓝色",
    "Excited state": "兴奋状态",
    "festive energy": "节日能量",
    "green": "绿色",
