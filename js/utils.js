...
function respecBuyables(layer) {
	...
	if (!player[layer].noRespecConfirm && !tmp[layer].buyables.noRespecConfirm && !confirm(tmp[layer].buyables.respecMessage || "您确定要重洗吗？ 这将迫使你做一个 \"" + (tmp[layer].name ? tmp[layer].name : layer) + "\" 也重置!")) return
