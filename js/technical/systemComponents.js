var systemComponents = {
	...
	'options-tab': {
		...
		<table>
			...
			<tr>
				<td><button class="opt" onclick="switchTheme()">Theme: {{ getThemeName().toUpperCase() }}</button></td>
			...
			<tr>
				<td><button class="opt" onclick="toggleOpt('particles')">Particle effects: {{ options.particles?"ON":"OFF" }}</button></td>
			</tr>
		</table>`
	},
